...
puts lines_read[0][start_char..start_char + 3]
puts lines_read[0][start_char..start_char + 3].squeeze

while start_char < lines_read[0].length
  char_code = lines_read[0][start_char..start_char + 3]
